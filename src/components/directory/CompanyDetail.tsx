        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <img
              ...
              className="w-32 h-32 object-contain bg-white rounded-lg shadow-md"
            />
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="flex items-center gap-2 text-[#C92536] hover:text-[#A61E2B]"
                >
            ...
            {company.products.map((product, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-6">
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-white bg-[#C92536] hover:bg-[#A61E2B] px-4 py-2 rounded-lg transition-colors duration-300"
                >
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <form className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 bg-[#C92536] text-white px-4 py-2 rounded-lg hover:bg-[#A61E2B] transition-colors duration-300"
                >
                  Send Inquiry
                </button>
                <button
